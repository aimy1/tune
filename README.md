...
> [!TIP]
> 推荐终端使用支持 [Nerd Fonts](https://www.nerdfonts.com/) 图标集的等宽字体（如 *JetBrainsMono Nerd Font*、*FiraCode Nerd Font*），以获得最佳的界面图标显示效果。

```text
┌────────────────────────────────────────────────────────────────────────────────────────┐
│  󰎆 网易云音乐        │ 󰎆 发现   󰓏 歌单   󰍉 搜索                        󰀄 个人中心     │
├──────────────────────┴─────────────────────────────────────────────────────────────────┤
│ 󰓏 我的歌单              󰍉 [ 搜索你喜欢的音乐 / 歌手 / 专辑...                         ] │
│   ▎ 󰓇  我喜欢的音乐    ──────────────────────────────────────────────────────────────── │
│      周杰伦精选集     ┌──────────────┐   󰎆 晴天 · 周杰伦                             │
│      每日推荐         │ [Album Art]  │   💿 专辑: 叶惠美 · 2003                       │
│                        │ (高清封面渲染)│   ⭐ 音质: 无损 FLAC                           │
│ 󰓏 收藏歌单             └──────────────┘   [ 󰐊 立即播放 ]   [ 󰓇 收藏歌曲 ]             │
│      摇滚经典                                                                         │
│                        🎵 播放列表 (奇偶斑马纹交替)                                     │
│                        1. 晴天 ──────────────────────────── 周杰伦 ───────────── 04:29 │
│                        2. 轨迹 ──────────────────────────── 周杰伦 ───────────── 05:22 │
├────────────────────────────────────────────────────────────────────────────────────────┤
│ 󰎆 晴天 - 周杰伦          []   []   []    󰑖    [󰕾 80%]        ▅▆▇▆▅▃ 01:23 / 04:29  │
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━●─────────────────────────────────────── │
