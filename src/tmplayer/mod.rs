...
fn tm_config_from_host(host: &HostConfig) -> data::config::Config {
    data::config::Config {
        ...
        visualize: match host.visualize {
            ...
            HostVisualizeMode::Circle => data::config::VisualizeMode::Circle,
            HostVisualizeMode::Particles => data::config::VisualizeMode::Particles,
            HostVisualizeMode::Mirror => data::config::VisualizeMode::Mirror,
        },
        ...
        // Fullscreen page data comes from Tune API flow; disable TMPlayer local fetch pipeline.
